...
//				CapabilityFlags.CLIENT_PLUGIN_AUTH_LENENC_CLIENT_DATA,
	...
	public static EnumSet<CapabilityFlags> getCapabilitiexinctr(Channel channel) {
	...
	public static void setCapabilitiexinctr(Channel channel, Set<CapabilityFlags> capabilities) {
		final Attribute<EnumSet<CapabilityFlags>> attr = channel.attr(capabilitiesKey);
